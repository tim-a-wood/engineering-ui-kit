...
export const FRONTEND_PALETTES: Readonly<Record<Exclude<FrontendPaletteId, 'custom'>, FrontendPalette>> = {
  midnight: palette(
    'midnight',
    'Midnight blue',
    'Flat near-black navy palette with restrained blue accents.',
    {},
    {},
  ),
  graphite: palette(
    'graphite',
    'Graphite',
    'Flat neutral palette for code and operations.',
    {
      canvas: '#f6f7f8',
      surfaceSubtle: '#ffffff',
      text: '#20262d',
  ...
  teal: palette(
    'teal',
    'Deep teal',
    'Flat calm palette for analysis and planning.',
    {
      accent: '#075e61',
      accentHover: '#087b7f',
      accentActive: '#04484a',
    ...
    },
    {
      canvas: '#062a2b',
      surface: '#0a3a3b',
      surfaceSubtle: '#0a3a3b',
      surfaceRaised: '#0a3a3b',
      text: '#f5fffe',
      textMuted: '#b9d8d5',
      textQuiet: '#91b7b4',
      border: '#2c6866',
  ...
  violet: palette(
    'violet',
    'Technical violet',
    'Flat focused palette for creative and agent work.',
    {
      accent: '#4f3698',
      accentHover: '#654ab2',
      accentActive: '#3a2872',
    ...
    },
    {
      canvas: '#1d1438',
      surface: '#2a1d4a',
      surfaceSubtle: '#2a1d4a',
      surfaceRaised: '#2a1d4a',
      text: '#fdfbff',
      textMuted: '#d6cced',
      textQuiet: '#afa1cf',
      border: '#5b477e',
  ...
  amber: palette(
    'amber',
    'Flight amber',
    'Flat warm palette for test and release work.',
    {
      accent: '#7a4b00',
      accentHover: '#985f00',
      accentActive: '#5d3900',
    ...
    },
    {
      canvas: '#2b1d08',
      surface: '#3b290d',
      surfaceSubtle: '#3b290d',
      surfaceRaised: '#3b290d',
      text: '#fffaf1',
      textMuted: '#e2d0af',
      textQuiet: '#baa57e',
      border: '#735a31',
...
export function buildFrontendDesignPrompt(config: FrontendDesignSystemConfig): string {
  ...
  return [
    ...
    '- In the default Midnight palette, use one near-black navy canvas and one subtly lighter component surface.',
    '- Do not create extra background tiers, blue panel bands, or decorative gradients.',
    '- Use a restrained blue accent only for actions, focus, selection, and data emphasis.',
