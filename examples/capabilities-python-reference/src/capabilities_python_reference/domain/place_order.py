...
Outcome`) directly — this is the "tiny domain operation" the composition
root wires through `dispatch`. It has exactly one success path and two
domain rejection paths (not exceptions — normal `Outcome.rejected`
returns, per CAP-ERA-001 §10.1):
