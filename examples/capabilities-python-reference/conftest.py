...
workaround applied to the runtime's own test suite). Inserting the paths
directly here is unaffected by that flag, because pytest's normal module
import machinery does not consult it.
"""
