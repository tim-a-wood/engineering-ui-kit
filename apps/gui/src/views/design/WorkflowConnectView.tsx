    ...
    <section className="design-connect" aria-label="Connect">
      ...
      {state.mode === 'sample' ? (
        <>
          ...
          <section className="design-connect-coverage" aria-label="Recorded connection proof">
            <div>
              <p className="overline">Recorded showcase proof</p>
              <h3>Recorded connection evidence</h3>
              <p>This read-only evidence is from earlier deterministic runs. It shows the trace form. It is not a live connection or current verification.</p>
            </div>
            <ul>
        ...
        <>
          <div className="design-connect-layout">
            ...
            <form className="design-connect-editor" onSubmit={(event) => {
              ...
              <section>
                ...
                <div>
                  ...
                  <div className="design-connect-kind-options" role="radiogroup" aria-label="Entry point type">
                    ...
                    <div className={`design-connect-kind-option ${kind === 'http' ? 'selected' : ''}`}>
                      <label>
                  ...
                  {kind === 'ui' ? (
                    ...
                    <div className="design-connect-http-fields">
                      ...
                      <div className="design-connect-field design-connect-http-url">
                        <label htmlFor="design-connect-local-url">Local URL</label>
                        <input id="design-connect-local-url" value={localBaseUrl} onChange={(event) => setLocalBaseUrl(event.target.value)} placeholder="http://127.0.0.1:3000" />
              ...
              <details className="design-connect-policies">
                <summary>Connection policy</summary>
                <label>
                  Exposure
          ...
          <section className="design-connect-coverage" aria-labelledby="design-connect-coverage-heading">
            <div>
              ...
              <h3 id="design-connect-coverage-heading">Available connection proof</h3>
              <p>The app does not show an unavailable connector as working. Module Build owns outbound adapters and composition-root generation. Connect proves the process, health route, inbound adapter, and approved operation route.</p>
            </div>
            <ul>
