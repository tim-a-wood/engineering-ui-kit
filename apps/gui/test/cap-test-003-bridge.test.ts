...
const CANONICAL_CAP_METHODS = [
  ...
  'capabilitiesExportImplementationWave',
  'capabilitiesProposeModuleBatch',
  'capabilitiesApproveModuleBatch',
  'capabilitiesPlanImplementationWaves',
  'capabilitiesCompileFrontendBrief',
