...
| `FND-PRI-002` | Equal light and dark modes. |
...
Light and dark modes are normative. Each frontend shall provide a labeled mode button and store the user choice.
...
- An enterprise shell with persistent context, a page header, a command region, and explicit validation status.
