# Phase 1 Validation Result Template

## Purpose

Record the Phase 1 scaffold validation outcome.

## Scope

This template applies to the Phase 1 scaffold package and can be copied for future validation runs.
...
| ID | Severity | Area | Finding | Correction |
|---|---|---|---|---|
| `<VAL-P1-DEFECT-001>` | `<Critical / Major / Minor / Observation>` | `<area>` | `<finding>` | `<correction>` |
...
Use `VAL-P1-RESULT-*` IDs for future validation-result records.
