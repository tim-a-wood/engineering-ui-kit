...
| WP11 | Production desktop integration | WP7–WP10 | Codex coordinator | desktop orchestrator/IPC/bridge, Guided+Design Build/Connect/Verify, runtime distribution, production packaged harness, A–E evidence | `9068520`, `f991c0a`, `d4c1220`, `5da30ca`, `e916a69`, `5e1e913`, `5547c7f`, `31f4bdc`, `39d28c6`, `c02b87e` | packaged A–E sequentially green on macOS, Windows, and Ubuntu; exact existing/recovery hashes; core 337, runtime-ts 96, GUI 181, Python 133; branch [run 29545112965](https://github.com/tim-a-wood/engineering-ui-kit/actions/runs/29545112965); `main` [run 29545605675](https://github.com/tim-a-wood/engineering-ui-kit/actions/runs/29545605675); [`CAPABILITIES-DESKTOP-INTEGRATION-EVIDENCE.md`](CAPABILITIES-DESKTOP-INTEGRATION-EVIDENCE.md) | **gate-green on `main`; complete** |
...
packaged journeys A–E pass on macOS, Windows, and Ubuntu. It was fast-forwarded to `main`, where
[run 29545605675](https://github.com/tim-a-wood/engineering-ui-kit/actions/runs/29545605675)
verified the same complete matrix. Real MATLAB and Azure remain separate
