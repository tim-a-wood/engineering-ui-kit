...
The interactive prototype includes the week book, lesson planning, classroom provision, resource library, reflection and teaching-mode views.

## Reference material

- [Product requirements](./product/PRD.md)
- [Approved visual benchmark](./product/visual-benchmarks/01-week-book-master-direction.png)
- [Interactive reference captures](./product/visual-benchmarks/reference-captures/)
